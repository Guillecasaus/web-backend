...
const { registerCtrl, loginCtrl, validateEmailCtrl, recoverPasswordCtrl, resetPasswordCtrl, verifyResetTokenCtrl, resendVerificationCodeCtrl } = require("../controllers/auth");
