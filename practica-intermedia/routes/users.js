...
const { getItems, getItem, createItem, updateItem, deleteItem, onboardingCtrl, companyCtrl, getUserByTokenCtrl, deleteUserByTokenCtrl, inviteUserCtrl } = require("../controllers/users")
...
router.post("/invite", authMiddleware, validatorCreateItem, inviteUserCtrl);
